      ...
      return this._cr.resolveComponent(type).then(function(cmpFactory) {
        ...
        dialog.onDestroy.subscribe(function() {
          if (typeof cmpRef.instance.canDestroy === 'function') {
            cmpRef.instance.canDestroy().then(function() {
...
System.registerDynamic("plugins/bootstrap/modal-backdrop", ["@angular/core", "../../angular2-modal", "./modal-container"], true, function($__require, exports, module) {
  ...
  var BSModalBackdrop = (function() {
    ...
    BSModalBackdrop = __decorate([core_1.Component({
      ...
      animations: [core_1.trigger('fade', [core_1.transition('void => in', [core_1.animate('150ms linear', core_1.keyframes([core_1.style({opacity: 0}), core_1.style({opacity: 0.5})]))]), core_1.state('out', core_1.style({opacity: 0})), core_1.transition('* => out', [core_1.animate('150ms, linear', core_1.keyframes([core_1.style({opacity: 0.5}), core_1.style({opacity: 0.5})])), core_1.animate('150ms linear', core_1.keyframes([core_1.style({opacity: 0.5}), core_1.style({opacity: 0})]))])])],
...
System.registerDynamic("plugins/bootstrap/modal-container", ["@angular/core", "../../angular2-modal", "./modal", "../../framework/utils"], true, function($__require, exports, module) {
  ...
  var BSModalContainer = (function() {
    ...
    BSModalContainer = __decorate([core_1.Component({
      ...
      animations: [core_1.trigger('fade', [core_1.transition('void => in', [core_1.animate('100ms, linear', core_1.keyframes([core_1.style({
        opacity: 0,
        transform: 'translate(0, -25%)'
      }), core_1.style({
        opacity: 0,
        transform: 'translate(0, -25%)'
      })])), core_1.animate('300ms linear', core_1.keyframes([core_1.style({
        opacity: 0,
        transform: 'translate(0, -25%)',
        offset: 0
      }), core_1.style({
        ...
        opacity: 0,
        transform: 'translate(0, -25%)'
      })), core_1.transition('in => out', [core_1.animate('150ms linear', core_1.keyframes([core_1.style({
        opacity: 1,
        transform: 'translate(0, 0)'
      }), core_1.style({
        opacity: 0,
    ...
    }), __metadata('design:paramtypes', [angular2_modal_1.DialogRef, core_1.ElementRef, angular2_modal_1.ModalCompileConfig, modal_1.Modal, core_1.ComponentResolver])], BSModalContainer);
...
System.registerDynamic("plugins/vex/presets/dropin-preset", ["../../../models/tokens", "../dialog-form-modal", "./dialog-preset", "../../../framework/utils"], true, function($__require, exports, module) {
  ...
  var DEFAULT_SETTERS = ['okBtn', 'cancelBtn', 'placeholder', 'showCloseButton'];
  ...
  var DropInPresetBuilder = (function(_super) {
    ...
    function DropInPresetBuilder(modal, dropInType, defaultValues) {
      ...
      _super.call(this, modal, utils_1.extend(utils_1.extend({
        modal: modal,
        dropInType: dropInType
      }, DEFAULT_VALUES), defaultValues || {}), DEFAULT_SETTERS, DropInPreset);
    }
...
System.registerDynamic("plugins/vex/modal-content", ["@angular/core", "./modal", "../../models/tokens", "../../models/dialog-ref"], true, function($__require, exports, module) {
  ...
  var VexModalContent = (function() {
    ...
    VexModalContent = __decorate([core_1.Component({
      ...
      encapsulation: core_1.ViewEncapsulation.None
    }), __metadata('design:paramtypes', [dialog_ref_1.DialogRef, core_1.ElementRef, modal_1.Modal, tokens_1.ModalCompileConfig, core_1.ComponentResolver])], VexModalContent);
  ...
  var Modal = (function() {
    ...
    Modal.prototype.open = function(componentType, context, bindings, viewContainer, inside) {
      ...
      var b = core_1.ReflectiveInjector.resolve([{
        ...
        provide: tokens_1.ModalRenderer,
        useValue: this._modalRenderer
      }, {
        provide: angular2_modal_1.DialogRef,
        useValue: dialog
      }, {
        provide: tokens_1.ModalCompileConfig,
        useValue: compileConfig
      }]);
      return this._modalRenderer.render(this._backdrop, viewContainer, b, dialog).then(function(dialog) {
        _stack.pushManaged(dialog);
        dialog.onDestroy.subscribe(function() {
          return _stack.remove(dialog);
        });
        return dialog;
      });
    };
...
System.registerDynamic("plugins/vex/modal-context", ["../../models/modal-open-context", "./../../framework/fluent-assign", "./../../framework/utils"], true, function($__require, exports, module) {
  ...
  var DEFAULT_SETTERS = ['className', 'overlayClassName', 'contentClassName', 'closeClassName', 'showCloseButton'];
...
System.registerDynamic("models/dialog-ref", ["@angular/core/src/facade/promise", "rxjs/Subject"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
